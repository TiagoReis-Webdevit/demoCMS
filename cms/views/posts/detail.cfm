...
<form class="form-horizontal" method="post" onsubmit="return checkPage();">
	...
	<div class="control-group">
		<label class="control-label" for="pstTitle">Category</label>
		<div class="controls">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea class="input-block-level" name="pstText" id="pstText" placeholder="Text" rows="10" cols="10"><cfoutput>#variables.post.getPstText()#</cfoutput></textarea>
			<span id="helpPstText" class="text-error" style="display: none;"></span>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="pstStatus">Published</label>
		<div class="controls">
			<select class="input" name="pstStatus" id="pstStatus" placeholder="Category">
				<option value="0"<cfif variables.post.getPstStatus() eq 0> selected</cfif>>No</option>
				<option value="1"<cfif variables.post.getPstStatus() eq 1> selected</cfif>>Yes</option>
			</select>
			<span id="helpPstText" class="text-error" style="display: none;"></span>
		</div>
	</div>
